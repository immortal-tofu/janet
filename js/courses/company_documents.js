  ...
  nodes: {
    ...
    rule2: {
      bot: [
        ...
        { en: "Your gut is a surprisingly good security sensor.", fr: "Ton intuition est un détecteur de sécurité étonnamment fiable.", es: "Tu intuición es un sensor de seguridad sorprendentemente bueno.", de: "Dein Bauchgefühl ist ein erstaunlich guter Sicherheitssensor.", it: "Il tuo istinto è un sensore di sicurezza sorprendentemente buono.", da: "Din mavefornemmelse er en overraskende god sikkerhedssensor.", bg: "Интуицията ти е изненадващо добър сензор за сигурност.", tr: "İçgüdün, şaşırtıcı derecede iyi bir güvenlik sensörüdür." },
        { en: "An odd email, a weird tone from a friend, a button you didn't expect — pause before you click.", fr: "Un email étrange, un ami au ton bizarre, un bouton qui sort de nulle part — marque une pause avant de cliquer.", es: "Un correo raro, un tono extraño en un amigo, un botón que no esperabas — haz una pausa antes de pulsar.", de: "Eine seltsame E-Mail, ein komischer Ton von einem Freund, ein unerwarteter Button — kurz innehalten, bevor du klickst.", it: "Un'email strana, un tono insolito da parte di un amico, un pulsante che non ti aspettavi — fermati prima di cliccare.", da: "En mærkelig e-mail, en sær tone fra en ven, en knap du ikke forventede — gør pause, før du klikker.", bg: "Странен имейл, необичаен тон от приятел, неочакван бутон — направи пауза преди да кликнеш.", tr: "Tuhaf bir e-posta, bir arkadaşının garip tonu, beklemediğin bir buton — tıklamadan önce dur." }
      ],
