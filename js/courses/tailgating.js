...
window.JANET_COURSES.tailgating = {
  ...
  nodes: {
    ...
    tips: {
      bot: [
        { en: "Defenses don't require kung fu:", fr: "La défense ne demande pas de kung-fu :", es: "Las defensas no requieren kung-fu:", de: "Verteidigung erfordert kein Kung-Fu:", it: "Le difese non richiedono kung-fu:", da: "Forsvar kræver ikke kung fu:", bg: "Защитата не изисква кунг-фу:", tr: "Savunma kung fu gerektirmez:" },
