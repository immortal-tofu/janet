  ...
  nodes: {
    ...
    outro: {
      bot: [
        ...
        { en: "Be a tiny bit suspicious. According to Janet, it's basically a love language. Bye for now! 🦈", fr: "Sois un peu méfiant·e. Selon Janet, c'est une déclaration d'amour. À très vite ! 🦈", es: "Sé un poquito desconfiado. Según Janet, es básicamente un lenguaje del amor. ¡Hasta pronto! 🦈", de: "Sei ein kleines bisschen misstrauisch. Laut Janet ist das im Grunde eine Liebessprache. Bis bald! 🦈", it: "Sii un pochino sospettoso. Secondo Janet, è praticamente un linguaggio dell'amore. A presto! 🦈", da: "Vær en lille smule mistænksom. Ifølge Janet er det dybest set et kærlighedssprog. Vi ses! 🦈", bg: "Бъди мъничко подозрителен. Според Janet това по същество е любовен език. До скоро! 🦈", tr: "Birazcık şüpheci ol. Janet'e göre bu aslında bir sevgi dilidir. Şimdilik hoşça kal! 🦈" }
      ],
      end: true
    }
  }
