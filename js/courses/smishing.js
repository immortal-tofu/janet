...
window.JANET_COURSES.smishing = {
  ...
  nodes: {
    start: {
      bot: [
        { en: "Hi there! Janet here, with the world's silliest word.", fr: "Salut ! C'est Janet, avec le mot le plus rigolo du monde.", es: "¡Hola! Soy Janet, con la palabra más ridícula del mundo.", de: "Hallo! Hier ist Janet, mit dem albernsten Wort der Welt.", it: "Ciao! Sono Janet, con la parola più buffa del mondo.", da: "Hej! Det er Janet, med verdens fjolleteste ord.", bg: "Здравей! Аз съм Janet, с най-смешната дума на света.", tr: "Merhaba! Ben Janet, dünyanın en saçma kelimesiyle birlikte." },
    ...
    templates: {
      bot: [
        { en: "The greatest hits, you've seen them all:", fr: "Les classiques que tu as forcément vus :", es: "Los grandes éxitos, los has visto todos:", de: "Die Klassiker, die du alle schon gesehen hast:", it: "I grandi classici, li hai visti tutti:", da: "De største hits, du har set dem alle:", bg: "Най-големите хитове, виждала си ги всичките:", tr: "En büyük hitler, hepsini görmüşsündür:" },
        { en: "📦 \"Your package couldn't be delivered. Pay €1.49 customs fee here.\"", fr: "📦 \"Votre colis n'a pas pu être livré. Payez 1,49 € de frais de douane ici.\"", es: "📦 \"Su paquete no se ha podido entregar. Pague 1,49 € de gastos de aduana aquí.\"", de: "📦 \"Ihr Paket konnte nicht zugestellt werden. Zahlen Sie hier 1,49 € Zollgebühr.\"", it: "📦 \"Il tuo pacco non ha potuto essere consegnato. Paga qui 1,49 € di spese doganali.\"", da: "📦 \"Din pakke kunne ikke leveres. Betal 1,49 € i toldgebyr her.\"", bg: "📦 \"Пратката Ви не можа да бъде доставена. Платете 1,49 € митническа такса тук.\"", tr: "📦 \"Kargonuz teslim edilemedi. 1,49 € gümrük ücretini buradan ödeyin.\"" },
        ...
        { en: "💸 \"You have a tax refund of €283. Click to receive.\"", fr: "💸 \"Vous avez un remboursement d'impôts de 283 €. Cliquez pour recevoir.\"", es: "💸 \"Tiene una devolución de Hacienda de 283 €. Pulse para recibirla.\"", de: "💸 \"Sie haben eine Steuerrückerstattung von 283 €. Klicken Sie zum Erhalt.\"", it: "💸 \"Hai un rimborso fiscale di 283 €. Clicca per riceverlo.\"", da: "💸 \"Du har et skatterefusion på 283 €. Klik for at modtage.\"", bg: "💸 \"Имате данъчно възстановяване от 283 €. Натиснете, за да получите.\"", tr: "💸 \"283 € tutarında vergi iadeniz var. Almak için tıklayın.\"" }
      ],
      next: "tricks"
    },
    tricks: {
    ...
    report: {
      bot: [
        { en: "Bonus move: *report and delete.*", fr: "Bonus : *signale et supprime.*", es: "Movimiento extra: *denuncia y borra.*", de: "Bonus-Tipp: *melden und löschen.*", it: "Mossa bonus: *segnala ed elimina.*", da: "Bonus-træk: *anmeld og slet.*", bg: "Бонус ход: *подай сигнал и изтрий.*", tr: "Bonus hamle: *bildir ve sil.*" },
