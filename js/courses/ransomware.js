...
window.JANET_COURSES.ransomware = {
  ...
  nodes: {
    ...
    rule321: {
      bot: [
        { en: "There's a classic rule: *3-2-1*.", fr: "Il y a une règle classique : *3-2-1*.", es: "Hay una regla clásica: *3-2-1*.", de: "Es gibt eine klassische Regel: *3-2-1*.", it: "C'è una regola classica: *3-2-1*.", da: "Der findes en klassisk regel: *3-2-1*.", bg: "Има класическо правило: *3-2-1*." },
        { en: "3 copies of your important files.", fr: "3 copies de tes fichiers importants.", es: "3 copias de tus archivos importantes.", de: "3 Kopien deiner wichtigen Dateien.", it: "3 copie dei tuoi file importanti.", da: "3 kopier af dine vigtige filer.", bg: "3 копия на важните ти файлове." },
        { en: "2 different kinds of storage.", fr: "2 types de stockage différents.", es: "2 tipos de almacenamiento distintos.", de: "2 verschiedene Speicherarten.", it: "2 tipi diversi di archiviazione.", da: "2 forskellige lagringstyper.", bg: "2 различни вида съхранение." },
        { en: "1 of them *offline* or *offsite* — disconnected from your computer.", fr: "1 d'entre elles *hors ligne* ou *ailleurs* — déconnectée de ton ordi.", es: "1 de ellas *fuera de línea* o *en otro sitio* — desconectada de tu ordenador.", de: "1 davon *offline* oder *außer Haus* — getrennt von deinem Computer.", it: "1 di esse *offline* o *fuori sede* — scollegata dal tuo computer.", da: "1 af dem *offline* eller *uden for stedet* — afkoblet fra din computer.", bg: "1 от тях *офлайн* или *на друго място* — изключена от компютъра ти." }
      ],
      next: "practical"
    },
    practical: {
      bot: [
        ...
        { en: "💾 An external hard drive, plugged in once a week, then unplugged.", fr: "💾 Un disque dur externe, branché une fois par semaine, puis débranché.", es: "💾 Un disco duro externo, conectado una vez por semana y luego desconectado.", de: "💾 Eine externe Festplatte, einmal pro Woche angeschlossen und dann wieder abgezogen.", it: "💾 Un hard disk esterno, collegato una volta a settimana e poi scollegato.", da: "💾 En ekstern harddisk, tilsluttet en gang om ugen og så taget ud.", bg: "💾 Външен твърд диск, включван веднъж седмично и след това изключван." },
