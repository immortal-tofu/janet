...
window.JANET_COURSES.ransomware = {
  ...
  nodes: {
    start: {
      bot: [
        { en: "Hi there! Janet here, with the malware that has, factually, the most theatrical flair.", fr: "Salut ! C'est Janet, avec le malware qui a, à vrai dire, le plus de panache théâtral.", es: "¡Hola! Soy Janet, con el malware que tiene, factualmente, el mayor toque teatral.", de: "Hallo! Janet hier, mit der Malware, die, faktisch, am theatralischsten ist.", it: "Ciao! Sono Janet, con il malware che ha, fattualmente, il maggior estro teatrale.", da: "Hej! Det er Janet, med den malware der, faktuelt, har mest teatralsk flair.", bg: "Здравей! Аз съм Janet, с малуера, който, технически, има най-много театрален размах.", tr: "Merhaba! Ben Janet, fiilen en teatral edaya sahip kötü amaçlı yazılımla birlikte." },
    ...
    rule321: {
      bot: [
        ...
        { en: "1 of them *offline* or *offsite* — disconnected from your computer.", fr: "1 d'entre elles *hors ligne* ou *ailleurs* — débranchée de ton ordi.", es: "1 de ellas *fuera de línea* o *en otro sitio* — desconectada de tu ordenador.", de: "1 davon *offline* oder *außer Haus* — getrennt von deinem Computer.", it: "1 di esse *offline* o *fuori sede* — scollegata dal tuo computer.", da: "1 af dem *offline* eller *uden for stedet* — afkoblet fra din computer.", bg: "1 от тях *офлайн* или *на друго място* — изключена от компютъра ти.", tr: "1 tanesi *çevrimdışı* veya *farklı bir yerde* — bilgisayarından bağlantısız." }
      ],
      next: "practical"
    },
    practical: {
