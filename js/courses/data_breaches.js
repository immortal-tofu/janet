...
window.JANET_COURSES.data_breaches = {
  ...
  nodes: {
    ...
    what: {
      bot: [
        { en: "Usually some mix of: 📧 Email addresses", fr: "En général un mélange de : 📧 Adresses email", es: "Normalmente una mezcla de: 📧 Direcciones de correo", de: "Meistens eine Mischung aus: 📧 E-Mail-Adressen", it: "Di solito un mix di: 📧 Indirizzi email", da: "Som regel en blanding af: 📧 E-mailadresser", bg: "Обикновено комбинация от: 📧 Имейл адреси", tr: "Genellikle şunların bir karışımı: 📧 E-posta adresleri" },
